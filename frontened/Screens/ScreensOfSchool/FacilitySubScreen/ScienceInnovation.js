...
const facilities = [
  {
    id: '1',
    title: 'Research Labs',
    description: "State-of-the-art labs for scientific research, experiments, and innovation.",
    image: require('../../../FacilitiesImage/researchlabs.jpg'),
    disabled: false
  },
  {
    id: '2',
    title: 'Innovation Hubs',
    description: 'Collaborative spaces designed to foster creative solutions and groundbreaking ideas.',
    image: require('../../../FacilitiesImage/innovationhubs.jpg'),
    disabled: false
  },
  {
    id: '3',
    title: 'Tech Labs',
    description: 'Cutting-edge labs for robotics, artificial intelligence, and machine learning.',
    image: require('../../../FacilitiesImage/techlabs.jpg'),
    disabled: false
  },
  {
    id: '4',
    title: 'Astronomy Observatories',
    description: 'Advanced telescopes and observation decks for space exploration studies.',
    image: require('../../../FacilitiesImage/astronomyobservation.jpg'),
    disabled: false
  },
  {
    id: '5',
    title: 'Biotech Labs',
    description: 'Facilities dedicated to biotechnological innovations and life sciences research.',
    image: require('../../../FacilitiesImage/biotechlabs.jpg'),
    disabled: false
  },
];

const ScienceAndInnovation = () => {
...
const [error, setError] = useState('');
  ...
  const handleIntroductionText = async () => {
    try {
      const payLoad = {
        loginEmail: email,
        facilityName: 'ScienceInnovation',
      ...
      <TouchableWithoutFeedback onPress={() => closeMenu()}>
        <View style={styles.container}>
          <LinearGradient colors={['#fff', '#fff']} style={styles.heroSection}>
            <Text style={styles.heroTitle}>Explore Our Science & Innovation</Text>
          ...
          >
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>
                {
                  editIntroduction ? 'Edit Explore Our Science & Innovation' : `Edit ${selectedFacility?.title}`
                }
              </Text>
              <TextInput
                style={styles.input}
...
export default ScienceAndInnovation;
