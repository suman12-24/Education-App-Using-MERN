...
const facilities = [
  {
    id: '1',
    title: 'Nature Trails',
    description: "Guided nature trails that teach about local flora and fauna.",
    image: require('../../../FacilitiesImage/naturetrails.jpg'),
    disabled: false
  },
  {
    id: '2',
    title: 'Outdoor Classrooms',
    description: 'Learning in an open-air classroom setting, with natural surroundings.',
    image: require('../../../FacilitiesImage/outdoorclassroom.jpg'),
    disabled: false
  },
  {
    id: '3',
    title: 'Wildlife Observation',
    description: 'Opportunities to observe and learn about wildlife in their natural habitats.',
    image: require('../../../FacilitiesImage/wildlifeobservation.jpg'),
    disabled: false
  },
  {
    id: '4',
    title: 'Adventure Sports',
    description: 'Engaging in adventure sports to build teamwork and physical fitness.',
    image: require('../../../FacilitiesImage/adventuresports.jpg'),
    disabled: false
  },
  {
    id: '5',
    title: 'Gardening Workshops',
    description: 'Hands-on gardening activities to connect with nature and grow food.',
    image: require('../../../FacilitiesImage/gardening.jpg'),
    disabled: false
  },
];
      ...
      <TouchableWithoutFeedback onPress={() => closeMenu()}>
        <View style={styles.container}>
          <LinearGradient colors={['#fff', '#fff']} style={styles.heroSection}>
            <Text style={styles.heroTitle}>Explore Our Outdoor Learning</Text>
          ...
          >
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>
                {
                  editIntroduction ? 'Edit Explore Our Outdoor Learning' : `Edit ${selectedFacility?.title}`
                }
              </Text>
              <TextInput
                style={styles.input}
...
export default OutdoorLearning;
