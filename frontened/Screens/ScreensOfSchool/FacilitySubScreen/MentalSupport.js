...
const facilities = [
  {
    ...
    description: 'Private spaces for one-on-one counseling sessions, ensuring confidentiality and comfort.',
    image: require('../../../FacilitiesImage/councelingrooms.jpg'),
    disabled: false
  },
  {
    id: '2',
    title: 'Relaxation Areas',
    description: 'Quiet zones equipped with comfortable seating, soothing music, and aromatherapy.',
    image: require('../../../FacilitiesImage/relaxationarea.jpg'),
    disabled: false
  },
  {
    id: '3',
    title: 'Meditation Center',
    description: 'Guided meditation sessions to help reduce stress and promote mindfulness.',
    image: require('../../../FacilitiesImage/meditationcanter.jpeg'),
    disabled: false
  },
  {
    id: '4',
    title: 'Support Groups',
    description: 'Group sessions where individuals share experiences and build connections.',
    image: require('../../../FacilitiesImage/supportgroup.jpg'),
    disabled: false
  },
];
      ...
      <TouchableWithoutFeedback onPress={() => closeMenu()}>
        <View style={styles.container}>
          <LinearGradient colors={['#fff', '#fff']} style={styles.heroSection}>
            <Text style={styles.heroTitle}>Explore Our Mental Support</Text>
          ...
          >
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>
                {
                  editIntroduction ? 'Edit Explore Our Mental Support' : `Edit ${selectedFacility?.title}`
                }
              </Text>
              <TextInput
                style={styles.input}
