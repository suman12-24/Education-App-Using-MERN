...
const facilities = [
  {
    ...
    description: 'Well-maintained sanitation stations at every corner for hygiene.',
    image: require('../../../FacilitiesImage/sanitization.jpg'),
    disabled: false
  },
  {
    id: '2',
    title: 'First Aid Facility',
    description: 'Fully equipped first aid rooms with trained medical staff.',
    image: require('../../../FacilitiesImage/firstaid.png'),
    disabled: false
  },
  {
    id: '3',
    title: 'Fire Safety Equipment',
    description: 'State-of-the-art fire extinguishers and evacuation plans.',
    image: require('../../../FacilitiesImage/firesafety.jpg'),
    disabled: false
  },
  {
    id: '4',
    title: 'Daily Cleaning',
    description: 'Regular cleaning and disinfection of all areas to ensure safety.',
    image: require('../../../FacilitiesImage/dailycleaning.jpg'),
    disabled: false
  },
  {
    id: '5',
    title: 'Emergency Exits',
    description: 'Clearly marked and accessible emergency exits throughout.',
    image: require('../../../FacilitiesImage/emergencyexit.jpg'),
    disabled: false
  },
];
      ...
      <TouchableWithoutFeedback onPress={() => closeMenu()}>
        <View style={styles.container}>
          <LinearGradient colors={['#fff', '#fff']} style={styles.heroSection}>
            <Text style={styles.heroTitle}>Explore Our Safety and Hygiene</Text>
          ...
          >
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>
                {
                  editIntroduction ? 'Edit Explore Our Safety and Hygiene' : `Edit ${selectedFacility?.title}`
                }
              </Text>
              <TextInput
                style={styles.input}
