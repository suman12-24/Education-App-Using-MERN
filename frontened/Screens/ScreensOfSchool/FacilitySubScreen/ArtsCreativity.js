...
const facilities = [
  {
    id: '1',
    title: 'Art Studios',
    description: "Fully equipped art studios for painting, sculpture, and mixed media projects.",
    image: require('../../../FacilitiesImage/artstudios.jpg'),
    disabled: false
  },
  {
    id: '2',
    title: 'Theater',
    description: 'A professional-grade theater for performances, drama, and dance shows.',
    image: require('../../../FacilitiesImage/Theater.png'),
    disabled: false
  },
  {
    id: '3',
    title: 'Design Labs',
    description: 'Creative spaces for graphic design, photography, and digital art creation.',
    image: require('../../../FacilitiesImage/designlabs.jpg'),
    disabled: false
  },
  {
    id: '4',
    title: 'Music Rooms',
    description: 'Soundproof rooms for practicing music, recording, and composing.',
    image: require('../../../FacilitiesImage/musicrooms.jpg'),
    disabled: false
  },
  {
    id: '5',
    title: 'Photography Studio',
    description: 'State-of-the-art photography equipment and backdrops for photo shoots.',
    image: require('../../../FacilitiesImage/photographystudio.jpg'),
    disabled: false
  },
];
...
const ArtsCreativity = () => {
  ...
  const handleIntroductionText = async () => {
    try {
      const payLoad = {
        loginEmail: email,
        facilityName: 'ArtsAndCreativity',
      ...
      <TouchableWithoutFeedback onPress={() => closeMenu()}>
        <View style={styles.container}>
          <LinearGradient colors={['#fff', '#fff']} style={styles.heroSection}>
            <Text style={styles.heroTitle}>Explore Our Arts and Creativity Facilities</Text>
          ...
          >
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>
                {
                  editIntroduction ? 'Edit Explore Our Arts and Creativity Facilities' : `Edit ${selectedFacility?.title}`
                }
              </Text>
              <TextInput
                style={styles.input}
