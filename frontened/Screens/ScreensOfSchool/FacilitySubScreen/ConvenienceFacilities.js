...
const facilities = [
  {
    id: '1',
    title: 'Cafeteria',
    description: "A school cafeteria is a place in a school where students eat, interact, and form friendships. It's also known as a dining hall or lunchroom.",
    image: require('../../../FacilitiesImage/cafeteria.jpg'),
    disabled: false
  },
  {
    id: '2',
    title: 'Parking Facilities',
    description: "A school's parking facility includes designated parking areas for students, faculty, staff, and visitors, as well as rules for parking lot behavior.",
    image: require('../../../FacilitiesImage/parking.jpg'),
    disabled: false
  },
  {
    id: '3',
    title: 'Student Lounge',
    description: 'Relax and unwind in our comfortable student lounge areas.',
    image: require('../../../FacilitiesImage/studentlounge.jpg'),
    disabled: false
  },
  {
    id: '4',
    title: 'Wi-Fi Zones',
    description: 'High-speed Wi-Fi available across the campus for all students.',
    image: require('../../../FacilitiesImage/wifizone.png'),
    disabled: false
  },

  {
    ...
    description: 'Fully equipped sports complex for all athletic activities.',
    image: require('../../../FacilitiesImage/sportscomplex.jpg'),
    disabled: false
  },
...
const ConvenienceFacilities = () => {
  ...
  const handleIntroductionText = async () => {
    try {
      const payLoad = {
        loginEmail: email,
        facilityName: 'ConvenienceFacilities',
      ...
      <TouchableWithoutFeedback onPress={() => closeMenu()}>
        <View style={styles.container}>
          <LinearGradient colors={['#fff', '#fff']} style={styles.heroSection}>
            <Text style={styles.heroTitle}>Explore Our Convenience Facilities</Text>
          ...
          >
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>
                {
                  editIntroduction ? 'Edit Explore Our Convenience Facilities' : `Edit ${selectedFacility?.title}`
                }
              </Text>
              <TextInput
                style={styles.input}
