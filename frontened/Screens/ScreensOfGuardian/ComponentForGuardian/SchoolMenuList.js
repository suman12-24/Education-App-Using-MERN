...
const SchoolMenuList = ({ GurdainFeesDisplayPdf, SchoolFaculityInfo, SchoolContactInfo }) => {
    ...
    return (
        <View style={styles.container}>
            <View style={styles.row}>
                <CustomButton
                    onPress={() => navigation.navigate('SchoolFeesStructureScreen', { GurdainFeesDisplayPdf })}
            ...
            <View style={styles.row}>
                <CustomButton
                    onPress={() => navigation.navigate('ContactDetails', { SchoolContactInfo })}
            ...
            <View style={styles.row}>
                <CustomButton
                    onPress={() => navigation.navigate('FacilitiesScreen', { SchoolFaculityInfo })}
                    title="Facilities"
                ...
                <View style={styles.spacer} />
                <TouchableOpacity
                    onPress={() => navigation.navigate('AdmissionEnquery')}
                    style={{
                        width: '45%', backgroundColor: '#0865ff',
                        marginTop: 7,
                        height: 40,
                        borderRadius: 8,
                        alignItems: 'center',
                    ...
                    <View style={styles.iconTextWrapper}>
                        <Icon name='question-answer' size={18} color="#f2ffff" style={styles.icon} />
                        <Text style={{
                            fontSize: 14,
                            fontWeight: '600',
                            color: '#f2ffff',
