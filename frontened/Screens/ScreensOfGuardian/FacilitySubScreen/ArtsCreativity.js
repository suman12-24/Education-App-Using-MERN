      ...
      <TouchableWithoutFeedback onPress={() => closeMenu()}>
        <View style={styles.container}>
          <LinearGradient colors={['#fff', '#fff']} style={styles.heroSection}>
            <Text style={styles.heroTitle}>Explore Our Arts & Creativity Facilities</Text>
          ...
          <Modal
            ...
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>
                {
                  editIntroduction ? 'Edit Explore Our Arts & Creativity Facilities' : `Edit ${selectedFacility?.title}`
                }
              </Text>
              <TextInput
                style={styles.input}
