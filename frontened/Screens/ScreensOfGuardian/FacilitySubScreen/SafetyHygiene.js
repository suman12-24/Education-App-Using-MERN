      ...
      <TouchableWithoutFeedback onPress={() => closeMenu()}>
        <View style={styles.container}>
          <LinearGradient colors={['#fff', '#fff']} style={styles.heroSection}>
            <Text style={styles.heroTitle}>Explore Our Safety and Hygiene Facilities</Text>
          ...
          <Modal
            ...
            <View style={styles.modalContent}>
              <Text style={styles.modalTitle}>
                {
                  editIntroduction ? 'EditExplore Our Safety and Hygiene Facilities' : `Edit ${selectedFacility?.title}`}
              </Text>
              <TextInput
                style={styles.input}
