...
const AllSecondarySchools = ({ route }) => {
    ...
    useEffect(() => {
        if (schools.length > 0) {
            ...
            Animated.stagger(
                150, // Faster stagger for more dynamic effect
                    ...
                    >
                        ...
                        <View style={styles.cardContent}>
                            ...
                            <View style={{ height: '90%', marginVertical: 10, width: '68%' }}>
                                ...
                                <View style={{
                                    flexDirection: 'row', marginTop: 7, justifyContent: 'center',
    ...
    if (error) {
        return (
            <View style={styles.loadingContainer}>
                <MaterialIcons name="error-outline" size={56} color="#dc3545" />
    ...
    const handleNavigation = (id) => {
        if (token) {
            navigation.navigate('SchoolDetailsScreen', { SchoolId: id });
        } else {
            setSchoolId(id);
            setIsModalVisible(true);
        }
    ...
    return (
        <View style={styles.container}>
            ...
            >
                <Animated.View style={[styles.headerContainer, { transform: [{ translateY: headerTranslateY }], opacity: headerAnim }]}>
                    <Text style={styles.headline}>Secondary Schools</Text>
                    <Text style={styles.subHeadline}>{boardName} Board</Text>
                </Animated.View>
            </LinearGradient>

            <Animated.View style={[styles.searchContainer, { transform: [{ translateY: searchBarTranslateY }], opacity: searchBarAnim }]}>
            ...
            <View style={styles.counterContainer}>
                <Text style={styles.counterText}>{schools.length} Schools Found</Text>
